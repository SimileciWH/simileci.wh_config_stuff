(custom-set-variables
 ...
 '(package-selected-packages
   '(detour evil-matchit treesit-auto color-identifiers-mode
	    markdown-mode avy elpy edit-indirect gripi-mode
	    markdown-toc grip-mode undo-tree lsp-treemacs
	    treemacs-projectile lsp-ivy c++-mode counsel-projectile
	    projectile avy--key-type yasnippet-snippets yasnippet
	    rainbow-delimiters dashboard mwim aweshell
	    multiple-cursors hl-column hl-cloumn col-highlight vline
	    hl-line+ all-the-icons treemacs-tab-bar treemacs-magit
	    treemacs-nerd-icons treemacs imenu-list general
	    counsel-etags nerd-icons-ivy-rich doom-themes tabspaces
	    ...
	    expand-region iedit nerd-icons-completion :emacs quickrun
